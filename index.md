...
### 美西时尚是一款专注高端时尚奢侈品的购物平台，在这个项目中我负责用vue进行项目整体结构的搭建，渲染以及通过路由实现页面的跳转，使用iscroll实现页面滚动，下拉刷新，上拉加载功能，在项目中，我用了vue组件的思想，然后用prop的方式实现了组件之间的传参,完成了页面的效果，减少了代码重复使用，优化了代码。 
